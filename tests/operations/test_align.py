...
def test_align_identical_labels(
    implementation: FrameLabeledArrayImplementation,
) -> None:
...
def test_align_reordered_labels(
    implementation: FrameLabeledArrayImplementation,
) -> None:
...
def test_align_single_array(implementation: FrameLabeledArrayImplementation) -> None:
...
def test_align_empty_tuple(implementation: FrameLabeledArrayImplementation) -> None:
...
def test_align_3d_arrays(implementation: FrameLabeledArrayImplementation) -> None:
...
def test_align_mixed_label_types(
    implementation: FrameLabeledArrayImplementation,
) -> None:
...
def test_align_partial_none_labels(
    implementation: FrameLabeledArrayImplementation,
) -> None:
...
def test_align_three_arrays(implementation: FrameLabeledArrayImplementation) -> None:
...
def test_align_preserves_label_structure(
    implementation: FrameLabeledArrayImplementation,
) -> None:
...
def test_align_axis_parameter_single_axis(
    implementation: FrameLabeledArrayImplementation,
) -> None:
...
def test_align_axis_parameter_multiple_axes(
    implementation: FrameLabeledArrayImplementation,
) -> None:
